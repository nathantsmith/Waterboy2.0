============================================
OpenSprinkler Beagle (OSBo) Google Calendar Demo
...
Preparation
-----------
1. Before running this demo, it is assumed that you have the Adafruit_BBIO.GPIO Python module installed.
...
3. As mentioned above, you need to create a Google calendar, set it to be public, and copy the calendar ID (available in the calendar settings page) to the correpsonding location in gcalendar.py. For exmaple:
