...
def prog_match(prog):
    ...
    adjusted_time = (lt[3] + (gv.sd['tz']-48)/4)
    this_minute = (adjusted_time*60)+lt[4]
...
def timing_loop():
	...
	#update_greeting()
        ...
        if gv.sd['en'] and not gv.sd['mm'] and (not gv.sd['bsy'] or not gv.sd['seq']):
            lt = time.gmtime(gv.now)
            adjusted_time = ((gv.sd['tz']-48)/4)+(lt[3])
            if (adjusted_time != last_min):
                last_min = (adjusted_time)
...
gv.sd = ({u"en": 1, u"seq": 1, u"mnp": 32, u"ir": [0], u"rsn": 0, u"htp": 8080, u"nst": 8,
            u"rdst": 0, u"loc": u"", u"tz": 28, u"tf": 1,  u"rs": 0, u"rd": 0, u"mton": 0,
            u"lr": u"100", u"sdt": 0, u"mas": 0, u"wl": 100, u"bsy": 0, u"lg": u"",
            u"urs": 0, u"nopts": 30, u"pwd": u"b3BlbmRvb3I=", u"password": u"", u"salt": u"", u"ipas": 0, u"rst": 1,
            u"mm": 0, u"mo": [0], u"rbt": 0, u"mtoff": 0, u"nprogs": 1, u"nbrd": 1, u"sh":1, u"wd":0, u"fname":"First", u"lname":"Last", u"bday":"06/17/93", u"email":"", u"ltct":32, u"lwlt":60, u"hwlt":200, u"tu": u"C",
